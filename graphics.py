...
class EasyGraphics(object):
    ...
    def __init__(self):
        ...
        self.batch = pyglet.graphics.Batch() # this will used for multiple sprites FIXME: Will eb used in the bomberman game Further stuff (rotation, deletion will be added along the way)
    ...
    def load_image(self, image_str):
        return pyglet.image.load(image_str)

    def load_and_create_sprite(self, image, x, y):
